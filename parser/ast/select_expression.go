...
func (n *SelectExpressionNode) MacroType() types.Type {
	return types.NameToType("Std::Elk::AST::SelectExpressionNode")
}
...
func (n *SelectCaseNode) MacroType() types.Type {
	return types.NameToType("Std::Elk::AST::SelectCaseNode")
}
