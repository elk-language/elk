...
func (n *GoExpressionNode) MacroType() types.Type {
	return types.NameToType("Std::Elk::AST::GoExpressionNode")
}

func (n *GoExpressionNode) traverse(parent Node, enter func(node, parent Node) TraverseOption, leave func(node, parent Node) TraverseOption) TraverseOption {
...
func (n *GoExpressionNode) ToValue() value.Value {
	return value.Ref(n)
}
