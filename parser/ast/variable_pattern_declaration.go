...
func (n *VariablePatternDeclarationNode) MacroType() types.Type {
	return types.NameToType("Std::Elk::AST::VariablePatternDeclarationNode")
}
...
func (n *VariablePatternDeclarationNode) ToValue() value.Value {
	return value.Ref(n)
}
