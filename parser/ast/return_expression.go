...
func (n *ReturnExpressionNode) MacroType() types.Type {
	return types.NameToType("Std::Elk::AST::ReturnExpressionNode")
}
...
func (*ReturnExpressionNode) Type() types.Type {
	return types.Never{}
}

func (*ReturnExpressionNode) TypeRef() types.Ref[types.Type] {
