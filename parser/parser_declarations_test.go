				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewVariableDeclarationNode(
							...
							V(P(4, 3, 1, 5), token.PUBLIC_IDENTIFIER, "foo"),
							nil,
							ast.NewIntLiteralNode(P(10, 1, 1, 11), V(P(10, 1, 1, 11), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewVariableDeclarationNode(
							...
							V(P(4, 3, 1, 5), token.PUBLIC_IDENTIFIER, "foo"),
							nil,
							ast.NewIntLiteralNode(P(10, 1, 2, 1), V(P(10, 1, 2, 1), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewVariableDeclarationNode(
							...
							ast.NewIntLiteralNode(P(15, 1, 1, 16), V(P(15, 1, 1, 16), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewConstantDeclarationNode(
							...
							V(P(6, 3, 1, 7), token.PUBLIC_CONSTANT, "Foo"),
							nil,
							ast.NewIntLiteralNode(P(12, 1, 1, 13), V(P(12, 1, 1, 13), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewConstantDeclarationNode(
							...
							V(P(6, 3, 1, 7), token.PUBLIC_CONSTANT, "Foo"),
							nil,
							ast.NewIntLiteralNode(P(12, 1, 2, 1), V(P(12, 1, 2, 1), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewConstantDeclarationNode(
							...
							ast.NewIntLiteralNode(P(17, 1, 1, 18), V(P(17, 1, 1, 18), token.INT, "5")),
						),
					),
				},
			),
							...
							[]ast.StatementNode{
								ast.NewExpressionStatementNode(
									...
									ast.NewAssignmentExpressionNode(
										...
										ast.NewIntLiteralNode(P(17, 1, 2, 8), V(P(17, 1, 2, 8), token.INT, "2")),
									),
								),
								ast.NewExpressionStatementNode(
									P(20, 4, 3, 2),
							...
							[]ast.StatementNode{
								ast.NewExpressionStatementNode(
									...
									ast.NewAssignmentExpressionNode(
										...
										ast.NewIntLiteralNode(P(18, 1, 2, 8), V(P(18, 1, 2, 8), token.INT, "2")),
									),
								),
								ast.NewExpressionStatementNode(
									P(21, 4, 3, 2),
							...
							[]ast.StatementNode{
								ast.NewExpressionStatementNode(
									...
									ast.NewAssignmentExpressionNode(
										...
										ast.NewIntLiteralNode(P(21, 1, 2, 8), V(P(21, 1, 2, 8), token.INT, "2")),
									),
								),
								ast.NewExpressionStatementNode(
									P(24, 4, 3, 2),
						...
						ast.NewMethodDefinitionNode(
							...
							[]ast.ParameterNode{
								ast.NewMethodParameterNode(
									...
									false,
									nil,
									ast.NewIntLiteralNode(P(12, 2, 1, 13), V(P(12, 2, 1, 13), token.INT, "32")),
									ast.NormalParameterKind,
								),
								ast.NewMethodParameterNode(
									P(16, 17, 1, 17),
						...
						ast.NewMethodDefinitionNode(
							...
							[]ast.ParameterNode{
								ast.NewMethodParameterNode(
									...
									true,
									nil,
									ast.NewIntLiteralNode(P(13, 2, 1, 14), V(P(13, 2, 1, 14), token.INT, "32")),
									ast.NormalParameterKind,
								),
								ast.NewMethodParameterNode(
									P(17, 18, 1, 18),
						...
						ast.NewInitDefinitionNode(
							...
							[]ast.ParameterNode{
								ast.NewMethodParameterNode(
									...
									false,
									nil,
									ast.NewIntLiteralNode(P(9, 2, 1, 10), V(P(9, 2, 1, 10), token.INT, "32")),
									ast.NormalParameterKind,
								),
								ast.NewMethodParameterNode(
									P(13, 17, 1, 14),
						...
						ast.NewInitDefinitionNode(
							...
							[]ast.ParameterNode{
								ast.NewMethodParameterNode(
									...
									true,
									nil,
									ast.NewIntLiteralNode(P(10, 2, 1, 11), V(P(10, 2, 1, 11), token.INT, "32")),
									ast.NormalParameterKind,
								),
								ast.NewMethodParameterNode(
									P(14, 18, 1, 15),
