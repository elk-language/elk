							...
							[]ast.StringLiteralContentNode{
								...
								ast.NewStringInterpolationNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(15, 1, 1, 16), V(P(15, 1, 1, 16), token.INT, "2")),
									),
								),
						...
						ast.NewClosureLiteralNode(
							...
							[]ast.ParameterNode{
								ast.NewFormalParameterNode(
									...
									"a",
									nil,
									ast.NewIntLiteralNode(P(5, 2, 1, 6), V(P(5, 2, 1, 6), token.INT, "32")),
									ast.NormalParameterKind,
								),
								ast.NewFormalParameterNode(
									P(9, 17, 1, 10),
							...
							[]ast.ExpressionNode{
								...
								ast.NewModifierNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(24, 1, 1, 25), V(P(24, 1, 1, 25), token.INT, "5")),
									),
						...
						ast.NewListLiteralNode(
							...
							[]ast.ExpressionNode{
								...
								ast.NewKeyValueExpressionNode(
									P(12, 10, 1, 13),
									ast.NewIntLiteralNode(P(12, 2, 1, 13), V(P(12, 2, 1, 13), token.INT, "10")),
								...
								ast.NewKeyValueExpressionNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(37, 1, 1, 38), V(P(37, 1, 1, 38), token.INT, "5")),
									),
								),
							},
						),
								...
								ast.NewModifierForInNode(
									...
									ast.NewKeyValueExpressionNode(
										...
										ast.NewBinaryExpressionNode(
											...
											ast.NewIntLiteralNode(P(44, 1, 1, 45), V(P(44, 1, 1, 45), token.INT, "5")),
										),
									),
									[]ast.ParameterNode{
						...
						ast.NewListLiteralNode(
							...
							[]ast.ExpressionNode{
								...
								ast.NewBinaryExpressionNode(
									...
									ast.NewIntLiteralNode(P(28, 1, 8, 7), V(P(28, 1, 8, 7), token.INT, "5")),
								),
							},
						),
					),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewHexListLiteralNode(
							...
							[]ast.IntCollectionContentNode{
								ast.NewIntLiteralNode(P(3, 3, 1, 4), V(P(3, 3, 1, 4), token.INT, "0xfff")),
								ast.NewIntLiteralNode(P(7, 3, 1, 8), V(P(7, 3, 1, 8), token.INT, "0xe12")),
							},
						),
					),
				},
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewHexListLiteralNode(
							...
							[]ast.IntCollectionContentNode{
								...
								ast.NewIntLiteralNode(P(12, 2, 1, 13), V(P(12, 2, 1, 13), token.INT, "0x12")),
							},
						),
					),
				},
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewBinListLiteralNode(
							P(0, 11, 1, 1),
							[]ast.IntCollectionContentNode{
								ast.NewIntLiteralNode(P(3, 3, 1, 4), V(P(3, 3, 1, 4), token.INT, "0b111")),
								ast.NewIntLiteralNode(P(7, 3, 1, 8), V(P(7, 3, 1, 8), token.INT, "0b100")),
							},
						),
					),
				},
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewBinListLiteralNode(
							P(0, 15, 1, 1),
							[]ast.IntCollectionContentNode{
								ast.NewIntLiteralNode(P(3, 3, 1, 4), V(P(3, 3, 1, 4), token.INT, "0b101")),
								ast.NewInvalidNode(P(7, 4, 1, 8), V(P(7, 4, 1, 8), token.ERROR, "invalid int literal")),
								ast.NewIntLiteralNode(P(12, 2, 1, 13), V(P(12, 2, 1, 13), token.INT, "0b10")),
							},
						),
					),
				},
							...
							[]ast.ExpressionNode{
								...
								ast.NewModifierNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(25, 1, 1, 26), V(P(25, 1, 1, 26), token.INT, "5")),
									),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewTupleLiteralNode(
							...
							[]ast.ExpressionNode{
								...
								ast.NewKeyValueExpressionNode(
									P(13, 10, 1, 14),
									ast.NewIntLiteralNode(P(13, 2, 1, 14), V(P(13, 2, 1, 14), token.INT, "10")),
								...
								ast.NewKeyValueExpressionNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(38, 1, 1, 39), V(P(38, 1, 1, 39), token.INT, "5")),
									),
								),
							},
						),
								...
								ast.NewModifierForInNode(
									...
									ast.NewKeyValueExpressionNode(
										...
										ast.NewBinaryExpressionNode(
											...
											ast.NewIntLiteralNode(P(45, 1, 1, 46), V(P(45, 1, 1, 46), token.INT, "5")),
										),
									),
									[]ast.ParameterNode{
						...
						ast.NewTupleLiteralNode(
							...
							[]ast.ExpressionNode{
								...
								ast.NewBinaryExpressionNode(
									...
									ast.NewIntLiteralNode(P(29, 1, 8, 7), V(P(29, 1, 8, 7), token.INT, "5")),
								),
							},
						),
					),
						...
						ast.NewMapLiteralNode(
							...
							[]ast.ExpressionNode{
								ast.NewKeyValueExpressionNode(
									...
									ast.NewIntLiteralNode(P(13, 1, 1, 14), V(P(13, 1, 1, 14), token.INT, "3")),
								),
								ast.NewKeyValueExpressionNode(
									P(16, 17, 1, 17),
								...
								ast.NewKeyValueExpressionNode(
									P(35, 10, 1, 36),
									ast.NewIntLiteralNode(P(35, 1, 1, 36), V(P(35, 1, 1, 36), token.INT, "5")),
								...
								ast.NewKeyValueExpressionNode(
									...
									ast.NewBinaryExpressionNode(
										...
										ast.NewIntLiteralNode(P(66, 1, 1, 67), V(P(66, 1, 1, 67), token.INT, "5")),
									),
									ast.NewIntLiteralNode(P(71, 1, 1, 72), V(P(71, 1, 1, 72), token.INT, "1")),
								),
								ast.NewKeyValueExpressionNode(
									P(74, 18, 1, 75),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							...
							false,
							nil,
							ast.NewIntLiteralNode(P(2, 1, 1, 3), V(P(2, 1, 1, 3), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							...
							true,
							nil,
							ast.NewIntLiteralNode(P(3, 1, 1, 4), V(P(3, 1, 1, 4), token.INT, "5")),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							P(0, 3, 1, 1),
							false,
							ast.NewIntLiteralNode(P(0, 1, 1, 1), V(P(0, 1, 1, 1), token.INT, "5")),
							nil,
						),
					),
				},
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							P(0, 4, 1, 1),
							false,
							ast.NewIntLiteralNode(P(0, 1, 1, 1), V(P(0, 1, 1, 1), token.INT, "2")),
							ast.NewIntLiteralNode(P(3, 1, 1, 4), V(P(3, 1, 1, 4), token.INT, "5")),
						),
					),
				},
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							...
							true,
							ast.NewIntLiteralNode(P(0, 1, 1, 1), V(P(0, 1, 1, 1), token.INT, "2")),
							ast.NewIntLiteralNode(P(4, 1, 1, 5), V(P(4, 1, 1, 5), token.INT, "5")),
						),
					),
				},
			),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewRangeLiteralNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(5, 1, 1, 6), V(P(5, 1, 1, 6), token.INT, "5")),
							),
							ast.NewRawStringLiteralNode(
								P(10, 5, 1, 11),
								"foo",
