...
func TestNamedValueLiteral(t *testing.T) {
	tests := testTable{
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewNamedValueLiteralNode(
							S(P(0, 1, 1), P(8, 1, 9)),
							"foo",
							ast.NewFloatLiteralNode(S(P(6, 1, 7), P(7, 1, 8)), "0.5"),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewNamedValueLiteralNode(
							S(P(0, 1, 1), P(7, 1, 8)),
							"foo",
							ast.NewFloatLiteralNode(S(P(5, 1, 6), P(6, 1, 7)), "0.5"),
						),
					),
				},
			),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewNamedValueLiteralNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewFloatLiteralNode(S(P(5, 1, 6), P(6, 1, 7)), "0.5"),
								ast.NewRawStringLiteralNode(S(P(10, 1, 11), P(14, 1, 15)), "hej"),
							),
						),
					),
				},
		...
		"can't have a string as the name": {
			...
			err: errors.ErrorList{
				errors.NewError(L("main", P(13, 1, 14), P(13, 1, 14)), "unexpected {, expected a statement separator `\\n`, `;`"),
			},
		},
	}
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewTypeLiteralNode(
							...
							ast.NewBinaryTypeExpressionNode(
								S(P(5, 1, 6), P(16, 1, 17)),
								T(S(P(9, 1, 10), P(9, 1, 10)), token.OR),
								ast.NewPublicConstantNode(S(P(5, 1, 6), P(7, 1, 8)), "Int"),
								ast.NewPublicConstantNode(S(P(11, 1, 12), P(16, 1, 17)), "String"),
							),
						),
					),
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewTypeLiteralNode(
							...
							ast.NewBinaryTypeExpressionNode(
								S(P(5, 1, 6), P(16, 1, 17)),
								T(S(P(9, 1, 10), P(9, 1, 10)), token.AND),
								ast.NewPublicConstantNode(S(P(5, 1, 6), P(7, 1, 8)), "Int"),
								ast.NewPublicConstantNode(S(P(11, 1, 12), P(16, 1, 17)), "String"),
							),
						),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewTypeLiteralNode(
							...
							ast.NewGenericConstantNode(
								...
								ast.NewConstantLookupNode(
									S(P(5, 1, 6), P(12, 1, 13)),
									ast.NewPublicConstantNode(S(P(5, 1, 6), P(7, 1, 8)), "Std"),
									ast.NewPublicConstantNode(S(P(10, 1, 11), P(12, 1, 13)), "Map"),
								),
								[]ast.ComplexConstantNode{
									ast.NewConstantLookupNode(
										S(P(14, 1, 15), P(24, 1, 25)),
										ast.NewPublicConstantNode(S(P(14, 1, 15), P(16, 1, 17)), "Std"),
										ast.NewPublicConstantNode(S(P(19, 1, 20), P(24, 1, 25)), "Symbol"),
									),
									ast.NewGenericConstantNode(
										S(P(27, 1, 28), P(38, 1, 39)),
										ast.NewPublicConstantNode(S(P(27, 1, 28), P(30, 1, 31)), "List"),
										[]ast.ComplexConstantNode{
											ast.NewPublicConstantNode(S(P(32, 1, 33), P(37, 1, 38)), "String"),
										},
									),
								},
							),
