					...
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(0, 1, 1, 1), "1"),
								ast.NewIntLiteralNode(P(4, 1, 1, 5), "2"),
							),
							ast.NewIntLiteralNode(P(8, 1, 1, 9), "3"),
						),
					),
				},
			),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								T(P(2, 1, 1, 3), token.PLUS),
								ast.NewIntLiteralNode(P(0, 1, 1, 1), "1"),
								ast.NewIntLiteralNode(P(4, 1, 2, 1), "2"),
							),
							ast.NewIntLiteralNode(P(8, 1, 3, 1), "3"),
						),
					),
				},
			),
				...
				[]ast.StatementNode{
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewUnaryExpressionNode(
							...
							ast.NewIntLiteralNode(P(4, 1, 2, 3), "2"),
						),
					),
					ast.NewExpressionStatementNode(
						P(6, 3, 3, 1),
						ast.NewUnaryExpressionNode(
							...
							ast.NewIntLiteralNode(P(8, 1, 3, 3), "3"),
						),
					),
				},
			),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(8, 1, 1, 9), "2"),
							),
							ast.NewUnaryExpressionNode(
								P(12, 3, 1, 13),
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(5, 1, 1, 6), "2"),
								ast.NewIntLiteralNode(P(10, 1, 1, 11), "3"),
							),
						),
					),
				},
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(5, 1, 2, 1), "2"),
								ast.NewIntLiteralNode(P(10, 1, 3, 1), "3"),
							),
						),
					),
				},
					...
					ast.NewExpressionStatementNode(
						...
						ast.NewUnaryExpressionNode(
							...
							ast.NewBinaryExpressionNode(
								...
								ast.NewIntLiteralNode(P(6, 1, 1, 7), "3"),
							),
						),
					),
				},
				...
				[]ast.StatementNode{
					ast.NewExpressionStatementNode(
						...
						ast.NewBinaryExpressionNode(
							...
							ast.NewIntLiteralNode(P(12, 1, 1, 13), "3"),
						),
					),
				},
			),
