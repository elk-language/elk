...
func (i UInt32) RightBitshiftUInt32(other UInt32) UInt32 {
	return i >> other
}
...
func (i UInt32) CompareVal(other Value) (Value, Value) {
	...
	return i.CompareUInt32(o).ToValue(), Undefined
}

func (i UInt32) CompareUInt32(other UInt32) SmallInt {
	if i > other {
		return SmallInt(1)
	}
	if i < other {
...
func initUInt32() {
	...
	RegisterNativeClass("Std::UInt32", "value.UInt32Class")

	UInt32Class.AddConstantString("Convertible", Ref(NewInterface()))
}
