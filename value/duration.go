...
func (d Duration) NanosecondsMod() int {
	return int(d.Go().Nanoseconds() % 1000)
}
...
func (d Duration) MicrosecondsMod() int {
	return int(d.Go().Microseconds() % 1000)
}
...
func (d Duration) MillisecondsMod() int {
	return int(d.Go().Milliseconds() % 1000)
}
...
func (d Duration) SecondsMod() int {
	return int(int64(d/Second) % 60)
}
...
func (d Duration) MinutesMod() int {
	return int(d / Minute % 60)
}
...
func (d Duration) HoursMod() int {
	return int(d / Hour % 24)
}
