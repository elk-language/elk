...
var NodeClass *Class     // Std::Elk::AST::Node

var StructBodyStatementNodeMixin *Class // Std::Elk::AST::StructBodyStatementNode
...
func initElkAST() {
	...
	NodeClass = NewClassWithOptions(ClassWithConstructor(UndefinedConstructor))
