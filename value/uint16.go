...
func (i UInt16) LeftBitshiftUInt16(other UInt16) UInt16 {
	return i << other
}

func (i UInt16) RightBitshiftUInt16(other UInt16) UInt16 {
	return i >> other
}
...
func (i UInt16) CompareVal(other Value) (Value, Value) {
	...
	return i.CompareUInt16(o).ToValue(), Undefined
}

func (i UInt16) CompareUInt16(other UInt16) SmallInt {
	if i > other {
		return SmallInt(1)
	}
	if i < other {
