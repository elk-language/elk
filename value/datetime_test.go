...
func TestDateTimeFormat(t *testing.T) {
	tests := map[string]struct {
		...
		"simple date with zero padding": {
			time:   value.NewDateTime(2023, 5, 3, 0, 0, 0, 0, nil),
			format: "%Y-%m-%d",
			want:   `2023-05-03`,
		},
		"simple date with space padding": {
			time:   value.NewDateTime(520, 5, 3, 0, 0, 0, 0, nil),
			format: "%_Y %_m %_d",
			want:   ` 520  5  3`,
		},
		"literal values": {
		...
		"full year week based no padding": {
			time:   value.NewDateTime(512, 5, 3, 0, 0, 0, 0, nil),
			format: "%-G",
			want:   "512",
		},
		...
		"year last two week based no padding": {
			time:   value.NewDateTime(2003, 5, 3, 0, 0, 0, 0, nil),
			format: "%-g",
			want:   "3",
		},
		...
		"month full name": {
			time:   value.NewDateTime(2003, 6, 3, 0, 0, 0, 0, nil),
			format: "%B",
			want:   "June",
		},
		...
		"day of year no padding": {
			time:   value.NewDateTime(2003, 2, 3, 0, 0, 0, 0, nil),
			format: "%-j",
			want:   "34",
		},
		...
		"hour no padding": {
			time:   value.NewDateTime(2003, 2, 3, 8, 9, 0, 0, nil),
			format: "%-H",
			want:   "8",
		},
		"hour space padding": {
		...
		"hour 12 no padding": {
			time:   value.NewDateTime(2003, 2, 3, 16, 9, 0, 0, nil),
			format: "%-I",
			want:   "4",
		},
		...
		"meridiem lowercase 12 PM": {
			time:   value.NewDateTime(2003, 2, 3, 12, 9, 0, 0, nil),
			format: "%I %P",
			want:   "12 pm",
		},
		"meridiem lowercase 12 AM": {
			time:   value.NewDateTime(2003, 2, 3, 0, 9, 0, 0, nil),
			format: "%I %P",
			want:   "12 am",
		},
		"meridiem lowercase 6 AM": {
			time:   value.NewDateTime(2003, 2, 3, 6, 9, 0, 0, nil),
			format: "%I %P",
			want:   "06 am",
		},
		...
		"second no padding": {
			time:   value.NewDateTime(2003, 2, 3, 16, 9, 7, 0, nil),
			format: "%-S",
			want:   "7",
		},
		...
		"millisecond no padding": {
			time:   value.NewDateTime(2023, 2, 3, 16, 9, 7, 62_000_000, nil),
			format: "%-L:%-3N",
			want:   "62:62",
		},
		...
		"timezone name": {
			time:   value.NewDateTime(2023, 2, 3, 16, 9, 7, 0, value.MustLoadTimezone("Europe/Warsaw")),
			format: "%Z",
			want:   "CET",
		},
		"timezone offset": {
		...
		"weekday full name": {
			time:   value.NewDateTime(2023, 11, 28, 16, 9, 7, 0, value.MustLoadTimezone("Europe/Warsaw")),
			format: "%A",
			want:   "Tuesday",
		},
		...
		"unix milliseconds": {
			time:   value.NewDateTime(2023, 11, 28, 16, 9, 7, 232_000_000, value.MustLoadTimezone("Europe/Warsaw")),
			format: "%Q:%3s",
			want:   "1701184147232:1701184147232",
		},
		"unix microseconds": {
			time:   value.NewDateTime(2023, 11, 28, 16, 9, 7, 232_765_000, value.MustLoadTimezone("Europe/Warsaw")),
			format: "%6s",
			want:   "1701184147232765",
		},
		"unix nanoseconds": {
			time:   value.NewDateTime(2023, 11, 28, 16, 9, 7, 232_765_397, value.MustLoadTimezone("Europe/Warsaw")),
			format: "%9s",
		...
		"ISO week no padding": {
			time:   value.NewDateTime(2023, 2, 3, 16, 9, 7, 0, nil),
			format: "%-V",
			want:   "5",
		},
		...
		"microsecond no padding": {
			time:   value.NewDateTime(2023, 2, 3, 16, 9, 7, 32_765_000, nil),
			format: "%-6N",
			want:   "32765",
		},
		...
		"nanosecond no padding": {
			time:   value.NewDateTime(2023, 2, 3, 16, 9, 7, 32_765_198, nil),
			format: "%-9N",
			want:   "32765198",
		},
