...
func TestTimeFormat(t *testing.T) {
	tests := map[string]struct {
		...
		"hour no padding": {
			time:   value.MakeTime(8, 9, 0, 0, 0, 0),
			format: "%-H",
			want:   "8",
		},
		"hour space padding": {
		...
		"hour 12 no padding": {
			time:   value.MakeTime(16, 9, 0, 0, 0, 0),
			format: "%-I",
			want:   "4",
		},
		...
		"meridiem lowercase 12 PM": {
			time:   value.MakeTime(12, 9, 0, 0, 0, 0),
			format: "%I %P",
			want:   "12 pm",
		},
		"meridiem lowercase 12 AM": {
			time:   value.MakeTime(0, 9, 0, 0, 0, 0),
			format: "%I %P",
			want:   "12 am",
		},
		"meridiem lowercase 6 AM": {
			time:   value.MakeTime(6, 9, 0, 0, 0, 0),
			format: "%I %P",
			want:   "06 am",
		},
		...
		"second no padding": {
			time:   value.MakeTime(16, 9, 7, 0, 0, 0),
			format: "%-S",
			want:   "7",
		},
		...
		"millisecond no padding": {
			time:   value.MakeTime(16, 9, 7, 62, 0, 0),
			format: "%-L:%-3N",
			want:   "62:62",
		},
		...
		"microsecond no padding": {
			time:   value.MakeTime(16, 9, 7, 0, 32_765, 0),
			format: "%-6N",
			want:   "32765",
		},
		...
		"nanosecond no padding": {
			time:   value.MakeTime(16, 9, 7, 32, 765, 198),
			format: "%-9N",
			want:   "32765198",
		},
