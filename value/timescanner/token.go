...
const (
	...
	MONTH_FULL_NAME_UPPERCASED                           // The uppercased full month name "JANUARY"
	MONTH_ABBREVIATED_NAME                               // The abbreviated month name "Jan"
	MONTH_ABBREVIATED_NAME_UPPERCASED                    // The uppercased abbreviated month name "JAN"
	...
	MERIDIAN_INDICATOR_LOWERCASED                        // Meridian indicator, lowercase (`am` or `pm`)
	MERIDIAN_INDICATOR_UPPERCASED                        // Meridian indicator, uppercase (`AM` or `PM`)
	...
	DAY_OF_WEEK_FULL_NAME_UPPERCASED                     // The full weekday name "SUNDAY"
	DAY_OF_WEEK_ABBREVIATED_NAME                         // The abbreviated name "Sun"
	DAY_OF_WEEK_ABBREVIATED_NAME_UPPERCASED              // The abbreviated name "SUN"
	...
	WEEK_OF_YEAR                                         // Week number of the year. The week starts with Monday. (0..53)
	WEEK_OF_YEAR_SPACE_PADDED                            // Week number of the year. The week starts with Monday. Space-padded ( 0..53)
	WEEK_OF_YEAR_ZERO_PADDED                             // Week number of the year. The week starts with Monday. Zero-padded (00..53)
...
var tokenNames = [...]string{
	...
	MONTH_ZERO_PADDED:                       "%m",
	MONTH_FULL_NAME:                         "%B",
	MONTH_FULL_NAME_UPPERCASED:              "%^B",
	MONTH_ABBREVIATED_NAME:                  "%b",
	MONTH_ABBREVIATED_NAME_UPPERCASED:       "%^b",
	DAY_OF_MONTH:                            "%-d",
	...
	MERIDIAN_INDICATOR_LOWERCASED:           "%P",
	MERIDIAN_INDICATOR_UPPERCASED:           "%p",
	MINUTE_OF_HOUR:                          "%-M",
	...
	DAY_OF_WEEK_FULL_NAME_UPPERCASED:        "%^A",
	DAY_OF_WEEK_ABBREVIATED_NAME:            "%a",
	DAY_OF_WEEK_ABBREVIATED_NAME_UPPERCASED: "%^a",
