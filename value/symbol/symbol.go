...
var (
	...
	ConstantNode         = value.ToSymbol("ConstantNode")
	ComplexConstantNode  = value.ToSymbol("ComplexConstantNode")
	PatternNode          = value.ToSymbol("PatternNode")
	LiteralPatternNode   = value.ToSymbol("LiteralPatternNode")
...
var (
	...
	L_to_ast_expr_node          = value.ToSymbol("to_ast_expr_node")
	L_to_ast_const_node         = value.ToSymbol("to_ast_const_node")
	L_to_ast_complex_const_node = value.ToSymbol("to_ast_complex_const_node")
	L_to_ast_pattern_node       = value.ToSymbol("to_ast_pattern_node")
	L_to_ast_pattern_expr_node  = value.ToSymbol("to_ast_pattern_expr_node")
...
var (
	...
	S_splice                   = value.ToSymbol("#splice")                   // #splice
