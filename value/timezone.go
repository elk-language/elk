...
func initTimezone() {
	...
	RegisterNativeConstant("Std::Timezone::UTC", "value.UTCTimezone", FetchGoType("*value.Timezone"))

	TimezoneClass.AddConstantString("LOCAL", Ref(LocalTimezone))
	RegisterNativeConstant("Std::Timezone::LOCAL", "value.LocalTimezone", FetchGoType("*value.Timezone"))
}
