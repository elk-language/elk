...
func (i Int64) LeftBitshiftInt64(other Int64) Int64 {
	if other < 0 {
		return i >> -other
	}
	return i << other
...
func (i Int64) ModuloInt64(other Int64) (Int64, Value) {
	if other == 0 {
...
func initInt64() {
	...
	RegisterNativeClass("Std::Int64", "value.Int64Class")
