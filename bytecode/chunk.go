...
func (c *Chunk) DisassembleInstruction(output io.Writer, offset, instructionIndex int) (int, error) {
	...
	case RETURN, ADD, SUBTRACT,
		...
		BITWISE_AND, BITWISE_OR, BITWISE_XOR, MODULO,
		EQUAL, STRICT_EQUAL, GREATER, GREATER_EQUAL, LESS, LESS_EQUAL:
	...
	case PREP_LOCALS16, SET_LOCAL16, GET_LOCAL16, JUMP_UNLESS, JUMP, JUMP_IF, LOOP, JUMP_IF_NIL:
