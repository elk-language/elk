...
const (
	...
	CALL_METHOD_TCO8                    // Call a method with tail call optimisation eg. `foo.bar(2)` (8 bit operand)
	...
	CALL_METHOD_PTR_TCO8                // Call a method pointer with an explicit receiver with tail call optimisation eg. `foo.bar(2)` (8 bit operand)
	CALL_METHOD_PTR_TCO16               // Call a method pointer with tail call optimisation eg. `foo.bar(2)` (16 bit operand)
	CALL_METHOD_PTR8                    // Call a method pointer eg. `foo.bar(2)` (8 bit operand)
	CALL_METHOD_PTR16                   // Call a method pointer eg. `foo.bar(2)` (16 bit operand)
	CALL8                               // Call the `call` method eg. `foo.call(2)` (8 bit operand)
	CALL16                              // Call the `call` method eg. `foo.call(2)` (16 bit operand)
	...
	CLOSE_UPVALUES_TO_1                 // Close upvalues down to index 1
	CLOSE_UPVALUES_TO_2                 // Close upvalues down to index 2
...
var opCodeNames = [...]string{
	...
	CALL_METHOD_PTR_TCO8:  "CALL_METHOD_PTR_TCO8",
	CALL_METHOD_PTR_TCO16: "CALL_METHOD_PTR_TCO16",
	CALL_METHOD_PTR8:      "CALL_METHOD_PTR8",
	CALL_METHOD_PTR16:     "CALL_METHOD_PTR16",
	CALL8:                 "CALL8",
	CALL16:                "CALL16",
	INCLUDE:               "INCLUDE",
	...
	CLOSE_UPVALUES_TO_1:   "CLOSE_UPVALUES_TO_1",
	CLOSE_UPVALUES_TO_2:   "CLOSE_UPVALUES_TO_2",
