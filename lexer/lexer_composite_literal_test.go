...
baz]`,
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.WORD_ARRAY_LIST_BEG),
				...
				T(S(P(17, 3, 4), P(17, 3, 4)), token.WORD_ARRAY_LIST_END),
			},
		},
		"symbol list": {
			input: "\\s[foo bar   baz]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.SYMBOL_ARRAY_LIST_BEG),
				...
				T(S(P(16, 1, 17), P(16, 1, 17)), token.SYMBOL_ARRAY_LIST_END),
			},
		},
		"hex list": {
			input: "\\x[ff 4_e   234]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.HEX_ARRAY_LIST_BEG),
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0xff"),
				V(S(P(6, 1, 7), P(8, 1, 9)), token.INT, "0x4e"),
				V(S(P(12, 1, 13), P(14, 1, 15)), token.INT, "0x234"),
				T(S(P(15, 1, 16), P(15, 1, 16)), token.HEX_ARRAY_LIST_END),
			},
		},
		"hex list with invalid content": {
			...
			want: []*token.Token{
				...
				T(S(P(17, 1, 18), P(17, 1, 18)), token.HEX_ARRAY_LIST_END),
			},
		},
		"hex list with invalid content at the end": {
			...
			want: []*token.Token{
				...
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0xff"),
				V(S(P(6, 1, 7), P(10, 1, 11)), token.ERROR, "invalid int literal"),
				T(S(P(11, 1, 12), P(11, 1, 12)), token.HEX_ARRAY_LIST_END),
		...
		"binary list with invalid content": {
			...
			want: []*token.Token{
				...
				T(S(P(17, 1, 18), P(17, 1, 18)), token.BIN_ARRAY_LIST_END),
			},
		},
	}
...
func TestHashSet(t *testing.T) {
	tests := testTable{
		"regular set": {
			input: "^[1, 2, 3.0, 'foo', :bar]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(1, 1, 2)), token.HASH_SET_LITERAL_BEG),
		...
		"word set": {
			input: "^w[foo bar   baz]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.WORD_HASH_SET_BEG),
				V(S(P(3, 1, 4), P(5, 1, 6)), token.RAW_STRING, "foo"),
				V(S(P(7, 1, 8), P(9, 1, 10)), token.RAW_STRING, "bar"),
				V(S(P(13, 1, 14), P(15, 1, 16)), token.RAW_STRING, "baz"),
				T(S(P(16, 1, 17), P(16, 1, 17)), token.WORD_HASH_SET_END),
			},
		},
		"symbol set": {
			input: "^s[foo bar   baz]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.SYMBOL_HASH_SET_BEG),
				V(S(P(3, 1, 4), P(5, 1, 6)), token.RAW_STRING, "foo"),
				V(S(P(7, 1, 8), P(9, 1, 10)), token.RAW_STRING, "bar"),
				V(S(P(13, 1, 14), P(15, 1, 16)), token.RAW_STRING, "baz"),
				T(S(P(16, 1, 17), P(16, 1, 17)), token.SYMBOL_HASH_SET_END),
			},
		},
		"hex set": {
			input: "^x[ff 4_e   234]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.HEX_HASH_SET_BEG),
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0xff"),
				V(S(P(6, 1, 7), P(8, 1, 9)), token.INT, "0x4e"),
				V(S(P(12, 1, 13), P(14, 1, 15)), token.INT, "0x234"),
				T(S(P(15, 1, 16), P(15, 1, 16)), token.HEX_HASH_SET_END),
			},
		},
		"hex set with invalid content": {
			...
			want: []*token.Token{
				...
				V(S(P(6, 1, 7), P(10, 1, 11)), token.ERROR, "invalid int literal"),
				V(S(P(14, 1, 15), P(16, 1, 17)), token.INT, "0x234"),
				T(S(P(17, 1, 18), P(17, 1, 18)), token.HEX_HASH_SET_END),
			},
		},
		"binary set": {
			input: "^b[11 1_0   101]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.BIN_HASH_SET_BEG),
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0b11"),
				V(S(P(6, 1, 7), P(8, 1, 9)), token.INT, "0b10"),
				V(S(P(12, 1, 13), P(14, 1, 15)), token.INT, "0b101"),
				T(S(P(15, 1, 16), P(15, 1, 16)), token.BIN_HASH_SET_END),
			},
		},
		"binary set with invalid content": {
			...
			want: []*token.Token{
				...
				V(S(P(6, 1, 7), P(10, 1, 11)), token.ERROR, "invalid int literal"),
				V(S(P(14, 1, 15), P(16, 1, 17)), token.INT, "0b101"),
				T(S(P(17, 1, 18), P(17, 1, 18)), token.BIN_HASH_SET_END),
			},
		},
	}
...
func TestArrayTuple(t *testing.T) {
	tests := testTable{
		...
		"word arrayTuple": {
			input: "%w[foo bar   baz]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.WORD_ARRAY_TUPLE_BEG),
				V(S(P(3, 1, 4), P(5, 1, 6)), token.RAW_STRING, "foo"),
				V(S(P(7, 1, 8), P(9, 1, 10)), token.RAW_STRING, "bar"),
				V(S(P(13, 1, 14), P(15, 1, 16)), token.RAW_STRING, "baz"),
				T(S(P(16, 1, 17), P(16, 1, 17)), token.WORD_ARRAY_TUPLE_END),
			},
		},
		"symbol arrayTuple": {
			input: "%s[foo bar   baz]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.SYMBOL_ARRAY_TUPLE_BEG),
				V(S(P(3, 1, 4), P(5, 1, 6)), token.RAW_STRING, "foo"),
				V(S(P(7, 1, 8), P(9, 1, 10)), token.RAW_STRING, "bar"),
				V(S(P(13, 1, 14), P(15, 1, 16)), token.RAW_STRING, "baz"),
				T(S(P(16, 1, 17), P(16, 1, 17)), token.SYMBOL_ARRAY_TUPLE_END),
			},
		},
		"hex arrayTuple": {
			input: "%x[ff 4_e   234]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.HEX_ARRAY_TUPLE_BEG),
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0xff"),
				V(S(P(6, 1, 7), P(8, 1, 9)), token.INT, "0x4e"),
				V(S(P(12, 1, 13), P(14, 1, 15)), token.INT, "0x234"),
				T(S(P(15, 1, 16), P(15, 1, 16)), token.HEX_ARRAY_TUPLE_END),
			},
		},
		"hex arrayTuple with invalid content": {
			...
			want: []*token.Token{
				...
				V(S(P(6, 1, 7), P(10, 1, 11)), token.ERROR, "invalid int literal"),
				V(S(P(14, 1, 15), P(16, 1, 17)), token.INT, "0x234"),
				T(S(P(17, 1, 18), P(17, 1, 18)), token.HEX_ARRAY_TUPLE_END),
			},
		},
		"binary arrayTuple": {
			input: "%b[11 1_0   101]",
			want: []*token.Token{
				T(S(P(0, 1, 1), P(2, 1, 3)), token.BIN_ARRAY_TUPLE_BEG),
				V(S(P(3, 1, 4), P(4, 1, 5)), token.INT, "0b11"),
				V(S(P(6, 1, 7), P(8, 1, 9)), token.INT, "0b10"),
				V(S(P(12, 1, 13), P(14, 1, 15)), token.INT, "0b101"),
				T(S(P(15, 1, 16), P(15, 1, 16)), token.BIN_ARRAY_TUPLE_END),
			},
		},
		"binary arrayTuple with invalid content": {
			...
			want: []*token.Token{
				...
				V(S(P(6, 1, 7), P(10, 1, 11)), token.ERROR, "invalid int literal"),
				V(S(P(14, 1, 15), P(16, 1, 17)), token.INT, "0b101"),
				T(S(P(17, 1, 18), P(17, 1, 18)), token.BIN_ARRAY_TUPLE_END),
			},
		},
	}
