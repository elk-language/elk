	...
	tests := testTable{
		...
		"incorrect hex delimiters": {
			...
			want: []*token.Token{
				...
				T(P(2, 1, 1, 3), token.LESS),
				V(P(3, 2, 1, 4), token.INT, "45"),
				V(P(5, 1, 1, 6), token.PUBLIC_IDENTIFIER, "a"),
				V(P(7, 3, 1, 8), token.INT, "101"),
		...
		"incorrect binary delimiters": {
			...
			want: []*token.Token{
				...
				T(P(2, 1, 1, 3), token.LESS),
				V(P(3, 3, 1, 4), token.INT, "110"),
				V(P(7, 3, 1, 8), token.INT, "101"),
				V(P(13, 3, 1, 14), token.INT, "111"),
				T(P(16, 1, 1, 17), token.GREATER),
			},
		},
	}
	...
	tests := testTable{
		"regular array": {
			...
			want: []*token.Token{
				...
				V(P(1, 1, 1, 2), token.INT, "1"),
				T(P(2, 1, 1, 3), token.COMMA),
				V(P(4, 1, 1, 5), token.INT, "2"),
...
baz]`,
		...
		"hex array": {
			...
			want: []*token.Token{
				...
				V(P(3, 2, 1, 4), token.INT, "0xff"),
				V(P(6, 3, 1, 7), token.INT, "0x4e"),
				V(P(12, 3, 1, 13), token.INT, "0x234"),
		...
		"binary array": {
			...
			want: []*token.Token{
				...
				V(P(3, 2, 1, 4), token.INT, "0b11"),
				V(P(6, 3, 1, 7), token.INT, "0b10"),
				V(P(12, 3, 1, 13), token.INT, "0b101"),
	...
	tests := testTable{
		"regular set": {
			...
			want: []*token.Token{
				...
				V(P(2, 1, 1, 3), token.INT, "1"),
				T(P(3, 1, 1, 4), token.COMMA),
				V(P(5, 1, 1, 6), token.INT, "2"),
