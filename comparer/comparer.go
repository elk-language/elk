...
func init() {
	...
	*Comparer = append(
		*Comparer,
		...
		cmpopts.IgnoreFields(ast.ConstructorCallNode{}, "Method"),
		cmpopts.IgnoreFields(ast.GenericConstructorCallNode{}, "Method"),
		cmpopts.IgnoreFields(ast.NewExpressionNode{}, "Method"),
		floatComparer,
		bigFloatComparer,
		float32Comparer,
		float64Comparer,
