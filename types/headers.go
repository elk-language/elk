...

	{
...

		{
...

			{
				...
				// Define methods
				namespace.DefineMethod("Create a new `ArrayList` containing the elements of `self`\nrepeated `n` times.", false, true, true, value.ToSymbol("*"), nil, []*Parameter{NewParameter(value.ToSymbol("n"), NameToType("Std::Int", env), NormalParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				namespace.DefineMethod("Create a new `ArrayList` containing the elements of `self`\nand another given `ArrayList` or `ArrayTuple`.", false, true, true, value.ToSymbol("+"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NewUnion(NameToType("Std::ArrayList", env), NameToType("Std::ArrayTuple", env)), NormalParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				namespace.DefineMethod("Adds the given value to the list.\n\nReallocates the underlying array if it is\ntoo small to hold it.", false, false, true, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Element", env), NormalParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				...
				namespace.DefineMethod("Adds the given values to the list.\n\nReallocates the underlying array if it is\ntoo small to hold them.", false, false, true, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::ArrayList::Element", env), PositionalRestParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				...
				namespace.DefineMethod("Check whether the given `value` is present in this list.", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Element", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Mutates the list.\n\nReallocates the underlying array to hold\nthe given number of new elements.\n\nExpands the `capacity` of the list by `new_slots`", false, false, true, value.ToSymbol("grow"), nil, []*Parameter{NewParameter(value.ToSymbol("new_slots"), NameToType("Std::Int", env), NormalParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the list.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::ArrayList::Iterator", env), Never{})
				...
				namespace.DefineMethod("", false, false, true, value.ToSymbol("map"), nil, nil, Void{}, Never{})
				namespace.DefineMethod("", false, false, true, value.ToSymbol("map_mut"), nil, nil, Void{}, Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("Returns `self`.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::ArrayList::Iterator", env), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Create a new `ArrayTuple` containing the elements of `self`\nand another given `ArrayTuple`.", false, true, true, value.ToSymbol("+"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::ArrayTuple", env), NormalParameterKind, false)}, NameToType("Std::ArrayTuple", env), Never{})
				...
				namespace.DefineMethod("Check whether the given `value` is present in this tuple.", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayTuple::Element", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the tuple.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::ArrayTuple::Iterator", env), Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("Returns `self`.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::ArrayTuple::Iterator", env), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Returns the result of negating the number.\n\n```\n\tvar a = 1.2\n\t-a #=> -1.2\n```", false, true, true, value.ToSymbol("-@"), nil, nil, NameToType("Std::Float", env), Never{})
				namespace.DefineMethod("Divide this float by another float.", false, true, true, value.ToSymbol("/"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::Float", env), NormalParameterKind, false)}, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("", false, true, true, value.ToSymbol("<"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::CoercibleNumeric", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("", false, true, true, value.ToSymbol("<="), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::CoercibleNumeric", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Create a new `HashMap` containing the pairs of `self`\nand another given `HashMap` or `HashRecord`.", false, true, true, value.ToSymbol("+"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NewUnion(NameToType("Std::HashMap", env), NameToType("Std::HashRecord", env)), NormalParameterKind, false)}, NameToType("Std::HashMap", env), Never{})
				...
				namespace.DefineMethod("Set the element under the given index to the given value.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, value.ToSymbol("[]="), nil, []*Parameter{NewParameter(value.ToSymbol("key"), NameToType("Std::HashMap::Key", env), NormalParameterKind, false), NewParameter(value.ToSymbol("value"), NameToType("Std::HashMap::Value", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Returns the number of key-value pairs that can be\nheld by the underlying array.\n\nThis value will change when the map gets resized,\nand the underlying array gets reallocated.", false, false, true, value.ToSymbol("capacity"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("Check whether the given `pair` is present in this map.", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NameToType("Std::Pair", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Check whether the given `key` is present in this map.", false, false, true, value.ToSymbol("contains_key"), nil, []*Parameter{NewParameter(value.ToSymbol("key"), NameToType("Std::HashMap::Key", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this map.", false, false, true, value.ToSymbol("contains_value"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashMap::Value", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Mutates the map.\n\nReallocates the underlying array to hold\nthe given number of new elements.\n\nExpands the `capacity` of the list by `new_slots`", false, false, true, value.ToSymbol("grow"), nil, []*Parameter{NewParameter(value.ToSymbol("new_slots"), NameToType("Std::Int", env), NormalParameterKind, false)}, NameToType("Std::HashMap", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the map.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashMap::Iterator", env), Never{})
				...
				namespace.DefineMethod("", false, false, true, value.ToSymbol("map"), nil, nil, Void{}, Never{})
				namespace.DefineMethod("", false, false, true, value.ToSymbol("map_values"), nil, nil, Void{}, Never{})
				namespace.DefineMethod("", false, false, true, value.ToSymbol("map_values_mut"), nil, nil, Void{}, Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("Returns `self`.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashMap::Iterator", env), Never{})
					namespace.DefineMethod("Get the next pair of the map.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, value.ToSymbol("next"), nil, nil, NameToType("Std::HashMap::Iterator::Element", env), NewSymbolLiteral("stop_iteration"))
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Create a new `HashRecord` containing the pairs of `self`\nand another given `HashRecord`.", false, true, true, value.ToSymbol("+"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::HashRecord", env), NormalParameterKind, false)}, NameToType("Std::HashRecord", env), Never{})
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this record.", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NameToType("Std::Pair", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Check whether the given `key` is present in this record.", false, false, true, value.ToSymbol("contains_key"), nil, []*Parameter{NewParameter(value.ToSymbol("key"), NameToType("Std::HashRecord::Key", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this record.", false, false, true, value.ToSymbol("contains_value"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashRecord::Value", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the record.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashRecord::Iterator", env), Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("Returns `self`.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashRecord::Iterator", env), Never{})
					namespace.DefineMethod("Get the next pair of the record.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, value.ToSymbol("next"), nil, nil, NameToType("Std::HashRecord::Iterator::Element", env), NewSymbolLiteral("stop_iteration"))
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Return the intersection of both sets.\n\nCreate a new `HashSet` containing only the elements\npresent both in `self` and `other`.", false, true, true, value.ToSymbol("&"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::HashSet", env), NormalParameterKind, false)}, NameToType("Std::HashSet", env), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new `HashSet` containing all the elements\npresent in `self` and `other`.", false, true, true, value.ToSymbol("+"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), NameToType("Std::HashSet", env), NormalParameterKind, false)}, NameToType("Std::HashSet", env), Never{})
				namespace.DefineMethod("Adds the given value to the set.\n\nDoes nothing if the value is already present in the set.\n\nReallocates the underlying array if it is\ntoo small to hold it.", false, false, true, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Element", env), NormalParameterKind, false)}, NameToType("Std::HashSet", env), Never{})
				namespace.DefineMethod("Check whether the given value is a `HashSet`\nwith the same elements.", false, true, true, value.ToSymbol("=="), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Check whether the given value is a `HashSet`\nwith the same elements.", false, true, true, value.ToSymbol("=="), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Get the element under the given index.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, value.ToSymbol("[]"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NameToType("Std::HashSet::Element", env), Never{})
				namespace.DefineMethod("Set the element under the given index to the given value.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, value.ToSymbol("[]="), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false), NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Element", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Adds the given values to the set.\n\nSkips a value if it is already present in the set.\n\nReallocates the underlying array if it is\ntoo small to hold them.", false, false, true, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::HashSet::Element", env), PositionalRestParameterKind, false)}, NameToType("Std::HashSet", env), Never{})
				namespace.DefineMethod("Returns the number of elements that can be\nheld by the underlying array.\n\nThis value will change when the set gets resized,\nand the underlying array gets reallocated.", false, false, true, value.ToSymbol("capacity"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this set.", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Element", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Mutates the set.\n\nReallocates the underlying array to hold\nthe given number of new elements.\n\nExpands the `capacity` of the list by `new_slots`", false, false, true, value.ToSymbol("grow"), nil, []*Parameter{NewParameter(value.ToSymbol("new_slots"), NameToType("Std::Int", env), NormalParameterKind, false)}, NameToType("Std::HashSet", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the set.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashSet::Iterator", env), Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("Returns `self`.", false, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::HashSet::Iterator", env), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Returns an iterator for this structure.", true, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::Iterator", env), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Adds the given value to the list.", true, false, true, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::List::Element", env), NormalParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				...
				namespace.DefineMethod("Check whether the given value is a list\nwith the same elements.", true, true, true, value.ToSymbol("=~"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Get the element under the given index.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", true, false, true, value.ToSymbol("[]"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NameToType("Std::List::Element", env), Never{})
				...
				namespace.DefineMethod("Adds the given values to the list.", true, false, true, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::List::Element", env), PositionalRestParameterKind, false)}, NameToType("Std::ArrayList", env), Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this list.", true, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::List::Element", env), NormalParameterKind, false)}, NameToType("Std::Bool", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the list.", true, false, true, value.ToSymbol("iterator"), nil, nil, NameToType("Std::Iterator", env), Never{})
				namespace.DefineMethod("Returns the number of elements present in the list.", true, false, true, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("", true, false, true, value.ToSymbol("map"), nil, nil, Void{}, Never{})
