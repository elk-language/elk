...

	{
...

		{
			...
			}
			{
				...
				namespace.Name() // noop - avoid unused variable error
				namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection", env).(*Interface), Never{}, Any{}, INVARIANT)})
				namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection", env).(*Interface), Never{}, Any{}, INVARIANT))
				...
				// Define methods
				namespace.DefineMethod("Returns the number of elements present in the collection.", true, false, true, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nReturns a new collection that consists of the elements returned\nby the given closure.", true, false, true, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
...

				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection::Base", env).(*Mixin), Never{}, Any{}, INVARIANT))
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableCollection::Base", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				namespace.Name() // noop - avoid unused variable error
				namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT)})
				namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT))
				...
				// Define methods
				namespace.DefineMethod("Return the intersection of both sets.\n\nCreate a new set containing only the elements\npresent both in `self` and `other`.", true, false, true, value.ToSymbol("&"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(Never{}, INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", true, false, true, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewUnion(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Adds the given value to the set.\n\nDoes nothing if the value is already present in the set.", true, false, true, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Adds the given values to the set.\n\nSkips a value if it is already present in the set.", true, false, true, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), PositionalRestParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this set.", true, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Iterates over the elements of this set,\nyielding them to the given closure.\n\nReturns a new ImmutableSet that consists of the elements returned\nby the given closure.", true, false, true, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", true, false, true, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewUnion(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet", env).(*Interface), Never{}, Any{}, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
...

				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet::Base", env).(*Mixin), Never{}, Any{}, INVARIANT))
					...
					namespace.DefineMethod("", false, false, true, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewUnion(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet::Base", env).(*Mixin), Never{}, Any{}, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::ImmutableSet::Base", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("", true, false, true, value.ToSymbol("=~"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Checks whether any element of this iterable satisfies the given predicate.\n\nMay never return if the iterable is infinite.", true, false, true, value.ToSymbol("any"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the number of elements matching the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("count"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NameToType("Std::Int", env), Never{})
				...
				namespace.DefineMethod("Returns a new iterable containing all elements except first elements that satisfy the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("drop_while"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Checks whether every element of this iterable satisfies the given predicate.\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("every"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns a new iterable containing only elements matching the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("filter"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Returns the first element matching the given predicate.\nReturns `nil` otherwise.\n\nMay never return if the iterable is infinite.", true, false, true, value.ToSymbol("find"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT)), Never{})
				namespace.DefineMethod("Returns the first element matching the given predicate.\nThrows an error otherwise.\n\nMay never return if the iterable is infinite.", true, false, true, value.ToSymbol("find_err"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
				namespace.DefineMethod("Returns the first element.\nThrows an unchecked error when the iterable is empty.", true, false, true, value.ToSymbol("first"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), Never{})
				namespace.DefineMethod("Returns the first element.\nThrows an error when the iterable is empty.", true, false, true, value.ToSymbol("first_err"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
				namespace.DefineMethod("Reduces the elements of this iterable to a single value by\niteratively combining each element with an initial value using the provided function.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("fold"), []*TypeParameter{NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("initial"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), Never{})
				namespace.DefineMethod("Returns the first index of element, or -1 if it could not be found.\n\nMay never return if the iterable is infinite.", true, false, true, value.ToSymbol("index_of"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NameToType("Std::Int", env), Never{})
				...
				namespace.DefineMethod("Returns the first element.\nThrows an unchecked error when the iterable is empty.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("last"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), Never{})
				namespace.DefineMethod("Returns the last element.\nThrows an error when the iterable is empty.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("last_err"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
				...
				namespace.DefineMethod("Returns a new iterable containing first elements satisfying the given predicate.\n\nMay never return if the iterable is infinite.", true, false, true, value.ToSymbol("take_while"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Creates a new collection that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("to_collection"), nil, nil, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Creates a new immutable collection that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("to_immutable_collection"), nil, nil, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Creates a new list that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("to_list"), nil, nil, NewGeneric(NameToType("Std::List", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Creates a new tuple that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("to_tuple"), nil, nil, NewGeneric(NameToType("Std::Tuple", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Returns the first element.\nReturns `nil` when the iterable is empty.", true, false, true, value.ToSymbol("try_first"), nil, nil, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT)), Never{})
				namespace.DefineMethod("Returns the first element.\nReturns `nil` when the collection is empty.\n\nNever returns if the iterable is infinite.", true, false, true, value.ToSymbol("try_last"), nil, nil, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable", env).(*Interface), Never{}, Any{}, INVARIANT)), Never{})
...

				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::Base", env).(*Mixin), Never{}, Any{}, INVARIANT))
				...
				}
				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT))
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, value.ToSymbol("any"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Bool{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("contains"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("count"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NameToType("Std::Int", env), Never{})
					...
					namespace.DefineMethod("", false, false, true, value.ToSymbol("drop_while"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("every"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Bool{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("filter"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("find"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT)), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("find_err"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
					namespace.DefineMethod("", false, false, true, value.ToSymbol("first"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("first_err"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
					namespace.DefineMethod("", false, false, true, value.ToSymbol("fold"), []*TypeParameter{NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("initial"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, INVARIANT), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("index_of"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NameToType("Std::Int", env), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("is_empty"), nil, nil, Bool{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("last"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("last_err"), nil, nil, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NameToType("Std::Iterable::NotFoundError", env))
					namespace.DefineMethod("", false, false, true, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Iterable", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					...
					namespace.DefineMethod("", false, false, true, value.ToSymbol("reject"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
					...
					namespace.DefineMethod("", false, false, true, value.ToSymbol("take_while"), nil, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), NormalParameterKind, false)}, Bool{}, Never{}), NormalParameterKind, false)}, Self{}, Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("to_collection"), nil, nil, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("to_immutable_collection"), nil, nil, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("to_list"), nil, nil, NewGeneric(NameToType("Std::List", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("to_tuple"), nil, nil, NewGeneric(NameToType("Std::Tuple", env).(*Interface), NewTypeArguments(map[value.Symbol]*TypeArgument{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("try_first"), nil, nil, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT)), Never{})
					namespace.DefineMethod("", false, false, true, value.ToSymbol("try_last"), nil, nil, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterable::FiniteBase", env).(*Mixin), Never{}, Any{}, INVARIANT)), Never{})
			...
			}
			{
...

				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterator::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Iterator::Base", env).(*Mixin), Never{}, Any{}, INVARIANT))
			...
			}
			{
				...
				namespace.DefineMethod("Get the element under the given index.\n\nThrows an error if the index is a negative number\nor is greater or equal to `length`.", true, false, true, value.ToSymbol("at"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple", env).(*Interface), Never{}, Any{}, INVARIANT), NameToType("Std::OutOfRangeError", env))
				namespace.DefineMethod("Get the element under the given index.\n\nReturns `nil` if the index is a negative number\nor is greater or equal to `length`.", true, false, true, value.ToSymbol("try_at"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple", env).(*Interface), Never{}, Any{}, INVARIANT)), Never{})
...

				{
					...
					namespace.Name() // noop - avoid unused variable error
					namespace.SetTypeParameters([]*TypeParameter{NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)})
					namespace.DefineSubtype(value.ToSymbol("Element"), NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple::Base", env).(*Mixin), Never{}, Any{}, INVARIANT))
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, value.ToSymbol("at"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple::Base", env).(*Mixin), Never{}, Any{}, INVARIANT), NameToType("Std::OutOfRangeError", env))
					namespace.DefineMethod("", false, false, true, value.ToSymbol("try_at"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NewNilable(NewTypeParameter(value.ToSymbol("Element"), NameToType("Std::Tuple::Base", env).(*Mixin), Never{}, Any{}, INVARIANT)), Never{})
