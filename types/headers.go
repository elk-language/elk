...

	{
...

		{
...

			{
				...
				namespace.DefineMethod("Create a new `ArrayList` containing the elements of `self`\nand another given `Tuple`.", false, true, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayList", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::ArrayList::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Adds the given value to the list.\n\nReallocates the underlying array if it is\ntoo small to hold it.", false, false, true, false, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, Self{}, Never{})
				...
				namespace.DefineMethod("Get the element under the given index.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, false, value.ToSymbol("[]"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NameToType("Std::ArrayList::Val", env), Never{})
				namespace.DefineMethod("Set the element under the given index to the given value.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, false, value.ToSymbol("[]="), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false), NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Adds the given values to the list.\n\nReallocates the underlying array if it is\ntoo small to hold them.", false, false, true, false, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::ArrayList::Val", env), PositionalRestParameterKind, false)}, Self{}, Never{})
				...
				namespace.DefineMethod("Check whether the given `value` is present in this list.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::ArrayList::Val", env), NameToType("Std::ArrayList::Val", env), NameToType("Std::ArrayList::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::ArrayList::Val", env), NameToType("Std::ArrayList::Val", env), NameToType("Std::ArrayList::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the list.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::ArrayList::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::ArrayList::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this list,\nyielding them to the given closure.\n\nReturns a new List that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayList", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the elements of this list,\nyielding them to the given closure.\n\nMutates the list in place replacing the elements with the ones\nreturned by the given closure.", false, false, true, false, value.ToSymbol("map_mut"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, NameToType("Std::ArrayList::Val", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Adds the given value to the list.", false, false, true, false, value.ToSymbol("push"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Removes the element from the list.\n\nReturns `true` if the element has been removed,\notherwise returns `false.", false, false, true, false, value.ToSymbol("remove"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::ArrayList::Val", env), NormalParameterKind, false)}, Bool{}, Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::ArrayList::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
			...
			}
			{
				...
				namespace.DefineMethod("Create a new `ArrayTuple` containing the elements of `self`\nand another given `Tuple`.", false, true, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayTuple", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::ArrayTuple::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				...
				namespace.DefineMethod("Get the element under the given index.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", false, false, true, false, value.ToSymbol("[]"), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false)}, NameToType("Std::ArrayTuple::Val", env), Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the tuple.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::ArrayTuple::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::ArrayTuple::Val", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this tuple,\nyielding them to the given closure.\n\nReturns a new Tuple that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ArrayTuple::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayTuple", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
...

				{
					...
					namespace.DefineMethod("Get the next element of the tuple.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::ArrayTuple::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::BeginlessClosedRange::Val", env), NameToType("Std::BeginlessClosedRange::Val", env), NameToType("Std::BeginlessClosedRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::BeginlessClosedRange::Val", env), NameToType("Std::BeginlessClosedRange::Val", env), NameToType("Std::BeginlessClosedRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::BeginlessClosedRange::Val", env), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::BeginlessOpenRange::Val", env), NameToType("Std::BeginlessOpenRange::Val", env), NameToType("Std::BeginlessOpenRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::BeginlessOpenRange::Val", env), NameToType("Std::BeginlessOpenRange::Val", env), NameToType("Std::BeginlessOpenRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::BeginlessOpenRange::Val", env), Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, False{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::ClosedRange::Val", env), NameToType("Std::ClosedRange::Val", env), NameToType("Std::ClosedRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::ClosedRange::Val", env), NameToType("Std::ClosedRange::Val", env), NameToType("Std::ClosedRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::ClosedRange::Val", env), Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::ClosedRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::ClosedRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Adds the given value to the collection.", true, false, true, false, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Collection::Val", env), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Adds the given values to the collection.", true, false, true, false, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::Collection::Val", env), PositionalRestParameterKind, false)}, Self{}, Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nReturns a new collection that consists of the elements returned\nby the given closure.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Collection::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Adds the given value to the collection.", true, false, true, false, value.ToSymbol("push"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Collection::Val", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Removes the element from the collection.\n\nReturns `true` if the element has been removed,\notherwise returns `false.", true, false, true, false, value.ToSymbol("remove"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Collection::Val", env), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Removes all given elements from the collection.\n\nReturns `true` if any elements have been removed,\notherwise returns `false.", true, false, true, false, value.ToSymbol("remove_all"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::Collection::Val", env), PositionalRestParameterKind, false)}, Bool{}, Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Collection::Base::Val", env), NormalParameterKind, false)}, Self{}, Never{})
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::Collection::Base::Val", env), PositionalRestParameterKind, false)}, Self{}, Never{})
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Collection::Base::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("remove_all"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::Collection::Base::Val", env), PositionalRestParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this container.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Container::Val", env), NameToType("Std::Container::Val", env), NameToType("Std::Container::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Container::Val", env), NameToType("Std::Container::Val", env), NameToType("Std::Container::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				mixin = NewMixin("", false, "", env)
				{
					...
					// Define methods
					namespace.DefineMethod("Returns the iterator for this range.\nOnly ranges of incrementable values can be iterated over.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::EndlessClosedRange::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::EndlessClosedRange::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				}
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::EndlessClosedRange::Val", env), NameToType("Std::EndlessClosedRange::Val", env), NameToType("Std::EndlessClosedRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::EndlessClosedRange::Val", env), NameToType("Std::EndlessClosedRange::Val", env), NameToType("Std::EndlessClosedRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::EndlessClosedRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::EndlessClosedRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				mixin = NewMixin("", false, "", env)
				{
					...
					// Define methods
					namespace.DefineMethod("Returns the iterator for this range.\nOnly ranges of incrementable values can be iterated over.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::EndlessOpenRange::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::EndlessOpenRange::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				}
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::EndlessOpenRange::Val", env), NameToType("Std::EndlessOpenRange::Val", env), NameToType("Std::EndlessOpenRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::EndlessOpenRange::Val", env), NameToType("Std::EndlessOpenRange::Val", env), NameToType("Std::EndlessOpenRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::EndlessOpenRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::EndlessOpenRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this map.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the key value pairs of this map,\nyielding them to the given closure.\n\nReturns a new ArrayList that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayList", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the key value pairs of this map,\nyielding them to the given closure.\n\nReturns a new HashMap that consists of the key value pairs returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_pairs"), []*TypeParameter{NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashMap", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the values of this map,\nyielding them to the given closure.\n\nReturns a new HashMap that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_values"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashMap::Value", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashMap", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the values of this map,\nyielding them to the given closure.\n\nMutates the map in place replacing the values with the ones\nreturned by the given closure.", false, false, true, false, value.ToSymbol("map_values_mut"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashMap::Value", env), NormalParameterKind, false)}, NameToType("Std::HashMap::Value", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
...

				{
					...
					namespace.DefineMethod("Get the next pair of the map.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Iterator::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Iterator::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this record.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new ArrayList that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayList", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new HashRecord that consists of the key value pairs returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_pairs"), []*TypeParameter{NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashRecord", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the values of this record,\nyielding them to the given closure.\n\nReturns a new HashRecord that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_values"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashRecord::Value", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashRecord", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
...

				{
					...
					namespace.DefineMethod("Get the next pair of the record.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Iterator::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Iterator::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Return the intersection of both sets.\nCreate a new `HashSet` containing only the elements\npresent both in `self` and `other`.", false, true, true, false, value.ToSymbol("&"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashSet", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(Never{}, INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new `HashSet` containing all the elements\npresent in `self` and `other`.", false, true, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashSet", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::HashSet::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Adds the given value to the set.\n\nDoes nothing if the value is already present in the set.\n\nReallocates the underlying array if it is\ntoo small to hold it.", false, false, true, false, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Val", env), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Check whether the given value is a `HashSet`\nwith the same elements.", false, true, true, false, value.ToSymbol("=="), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Check whether the given value is a `HashSet`\nwith the same elements.", false, true, true, false, value.ToSymbol("=~"), nil, []*Parameter{NewParameter(value.ToSymbol("other"), Any{}, NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Adds the given values to the set.\n\nSkips a value if it is already present in the set.\n\nReallocates the underlying array if it is\ntoo small to hold them.", false, false, true, false, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::HashSet::Val", env), PositionalRestParameterKind, false)}, Self{}, Never{})
				...
				namespace.DefineMethod("Check whether the given `value` is present in this set.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::HashSet::Val", env), NameToType("Std::HashSet::Val", env), NameToType("Std::HashSet::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::HashSet::Val", env), NameToType("Std::HashSet::Val", env), NameToType("Std::HashSet::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Mutates the set.\n\nReallocates the underlying array to hold\nthe given number of new elements.\n\nExpands the `capacity` of the list by `new_slots`", false, false, true, false, value.ToSymbol("grow"), nil, []*Parameter{NewParameter(value.ToSymbol("new_slots"), NameToType("Std::Int", env), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Returns an iterator that iterates\nover each element of the set.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::HashSet::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::HashSet::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this set,\nyielding them to the given closure.\n\nReturns a new HashSet that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::HashSet::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashSet", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Adds the given value to the set.\n\nReturns `false` if the value is already present in the set.\nOtherwise returns `true`.\n\nReallocates the underlying array if it is\ntoo small to hold it.", false, false, true, false, value.ToSymbol("push"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Val", env), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Removes the element from the set.\n\nReturns `true` if the element has been removed,\notherwise returns `false.", false, false, true, false, value.ToSymbol("remove"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::HashSet::Val", env), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new `HashSet` containing all the elements\npresent in `self` and `other`.", false, true, true, false, value.ToSymbol("|"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::HashSet", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::HashSet::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the set.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::HashSet::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Returns the number of elements present in the collection.", true, false, true, false, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nReturns a new collection that consists of the elements returned\nby the given closure.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ImmutableCollection::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
...

				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ImmutableCollection::Base::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Return the intersection of both sets.\n\nCreate a new set containing only the elements\npresent both in `self` and `other`.", false, false, true, false, value.ToSymbol("&"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(Never{}, COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", false, false, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::ImmutableSet::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Iterates over the elements of this set,\nyielding them to the given closure.\n\nReturns a new ImmutableSet that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ImmutableSet::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", false, false, true, false, value.ToSymbol("|"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::ImmutableSet::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Checks whether any element of this iterable satisfies the given predicate.\n\nMay never return if the iterable is infinite.", true, false, true, false, value.ToSymbol("any"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Bool{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Check whether the given `value` is present in this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the number of elements matching the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("count"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NameToType("Std::Int", env), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns a new iterable containing all elements except first `n` elements.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("drop"), nil, []*Parameter{NewParameter(value.ToSymbol("n"), NameToType("Std::Int", env), NormalParameterKind, false)}, Self{}, NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns a new iterable containing all elements except first elements that satisfy the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("drop_while"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Checks whether every element of this iterable satisfies the given predicate.\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("every"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Bool{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns a new iterable containing only elements matching the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("filter"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns the first element matching the given predicate.\nReturns `nil` otherwise.\n\nMay never return if the iterable is infinite.", true, false, true, false, value.ToSymbol("find"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewNilable(NameToType("Std::Iterable::Val", env)), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns the first element matching the given predicate.\nThrows an error otherwise.\n\nMay never return if the iterable is infinite.", true, false, true, false, value.ToSymbol("find_err"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NameToType("Std::Iterable::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns the first element.\nThrows an unchecked error when the iterable is empty.", true, false, true, false, value.ToSymbol("first"), nil, nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the first element.\nThrows an error when the iterable is empty.", true, false, true, false, value.ToSymbol("first_err"), nil, nil, NameToType("Std::Iterable::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Reduces the elements of this iterable to a single value by\niteratively combining each element with an initial value using the provided function.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("fold"), []*TypeParameter{NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("initial"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns the first index of element, or -1 if it could not be found.\n\nMay never return if the iterable is infinite.", true, false, true, false, value.ToSymbol("index_of"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Val", env), INVARIANT), NormalParameterKind, false)}, NameToType("Std::Int", env), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Checks whether the iterable is empty.", true, false, true, false, value.ToSymbol("is_empty"), nil, nil, Bool{}, NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the first element.\nThrows an unchecked error when the iterable is empty.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("last"), nil, nil, NameToType("Std::Iterable::Val", env), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the last element.\nThrows an error when the iterable is empty.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("last_err"), nil, nil, NameToType("Std::Iterable::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns the number of elements present in the iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Iterates over the elements of this iterable,\nyielding them to the given closure.\n\nReturns a new iterable that consists of the elements returned\nby the given closure.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Iterable", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Err"): NewTypeArgument(Never{}, COVARIANT)}, []value.Symbol{value.ToSymbol("Val"), value.ToSymbol("Err")})), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Reduces the elements of this iterable to a single value by\niteratively combining them using the provided function.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("reduce"), []*TypeParameter{NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns a new iterable containing only elements not matching the given predicate.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("reject"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Returns a new iterable containing only the first `n` elements.", true, false, true, false, value.ToSymbol("take"), nil, []*Parameter{NewParameter(value.ToSymbol("n"), NameToType("Std::Int", env), NormalParameterKind, false)}, Self{}, NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns a new iterable containing first elements satisfying the given predicate.\n\nMay never return if the iterable is infinite.", true, false, true, false, value.ToSymbol("take_while"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::Err", env)))
				namespace.DefineMethod("Creates a new collection that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("to_collection"), []*TypeParameter{NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::Val", env), Any{}, nil, INVARIANT)}, nil, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::Val", env), Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Creates a new immutable collection that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("to_immutable_collection"), nil, nil, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::Iterable::Val", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Creates a new list that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("to_list"), []*TypeParameter{NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::Val", env), Any{}, nil, INVARIANT)}, nil, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::Val", env), Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Creates a new tuple that contains the elements of this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("to_tuple"), nil, nil, NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NameToType("Std::Iterable::Val", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the first element.\nReturns `nil` when the iterable is empty.", true, false, true, false, value.ToSymbol("try_first"), nil, nil, NewNilable(NameToType("Std::Iterable::Val", env)), NameToType("Std::Iterable::Err", env))
				namespace.DefineMethod("Returns the first element.\nReturns `nil` when the collection is empty.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("try_last"), nil, nil, NewNilable(NameToType("Std::Iterable::Val", env)), NameToType("Std::Iterable::Err", env))
...

				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), NameToType("Std::Iterable::Base::Err", env))
				...
				}
				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("any"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Bool{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("count"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NameToType("Std::Int", env), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("drop"), nil, []*Parameter{NewParameter(value.ToSymbol("n"), NameToType("Std::Int", env), NormalParameterKind, false)}, Self{}, NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("drop_while"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("every"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Bool{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("filter"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("find"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewNilable(NameToType("Std::Iterable::FiniteBase::Val", env)), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("find_err"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NameToType("Std::Iterable::FiniteBase::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("first"), nil, nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("first_err"), nil, nil, NameToType("Std::Iterable::FiniteBase::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("fold"), []*TypeParameter{NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("initial"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("I"), nil, Never{}, Any{}, nil, INVARIANT), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("index_of"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("element"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Val", env), INVARIANT), NormalParameterKind, false)}, NameToType("Std::Int", env), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_empty"), nil, nil, Bool{}, NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("last"), nil, nil, NameToType("Std::Iterable::FiniteBase::Val", env), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("last_err"), nil, nil, NameToType("Std::Iterable::FiniteBase::Val", env), NewUnion(NameToType("Std::Iterable::NotFoundError", env), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Iterable", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Err"): NewTypeArgument(Never{}, COVARIANT)}, []value.Symbol{value.ToSymbol("Val"), value.ToSymbol("Err")})), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("reduce"), []*TypeParameter{NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, nil, INVARIANT), NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("reject"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("take"), nil, []*Parameter{NewParameter(value.ToSymbol("n"), NameToType("Std::Int", env), NormalParameterKind, false)}, Self{}, NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("take_while"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Val", env), NormalParameterKind, false)}, Bool{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewUnion(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT), NameToType("Std::Iterable::FiniteBase::Err", env)))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("to_collection"), []*TypeParameter{NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), Any{}, nil, INVARIANT)}, nil, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("to_immutable_collection"), nil, nil, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::Iterable::FiniteBase::Val", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("to_list"), []*TypeParameter{NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), Any{}, nil, INVARIANT)}, nil, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("T"), nil, NameToType("Std::Iterable::FiniteBase::Val", env), Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("to_tuple"), nil, nil, NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NameToType("Std::Iterable::FiniteBase::Val", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("try_first"), nil, nil, NewNilable(NameToType("Std::Iterable::FiniteBase::Val", env)), NameToType("Std::Iterable::FiniteBase::Err", env))
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("try_last"), nil, nil, NewNilable(NameToType("Std::Iterable::FiniteBase::Val", env)), NameToType("Std::Iterable::FiniteBase::Err", env))
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Returns the upper bound of the range.\nReturns `nil` if the range is endless.", true, false, true, false, value.ToSymbol("end"), nil, nil, NewNilable(NameToType("Std::IterableRange::Val", env)), Never{})
				...
				namespace.DefineMethod("Returns the lower bound of the range.\nReturns `nil` if the Range is beginless.", true, false, true, false, value.ToSymbol("start"), nil, nil, NewNilable(NameToType("Std::IterableRange::Val", env)), Never{})
			...
			}
			{
				...
				mixin = NewMixin("", false, "", env)
				{
					...
					// Define methods
					namespace.DefineMethod("Returns the iterator for this range.\nOnly ranges of incrementable values can be iterated over.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::LeftOpenRange::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::LeftOpenRange::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				}
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::LeftOpenRange::Val", env), NameToType("Std::LeftOpenRange::Val", env), NameToType("Std::LeftOpenRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::LeftOpenRange::Val", env), NameToType("Std::LeftOpenRange::Val", env), NameToType("Std::LeftOpenRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::LeftOpenRange::Val", env), Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::LeftOpenRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::LeftOpenRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Create a new `List` containing the elements of `self`\nand another given `Tuple`.", false, true, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::List::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Set the element under the given index to the given value.\n\nThrows an unchecked error if the index is a negative number\nor is greater or equal to `length`.", true, false, true, false, value.ToSymbol("[]="), nil, []*Parameter{NewParameter(value.ToSymbol("index"), NameToType("Std::AnyInt", env), NormalParameterKind, false), NewParameter(value.ToSymbol("value"), NameToType("Std::List::Val", env), NormalParameterKind, false)}, Void{}, Never{})
				namespace.DefineMethod("Iterates over the elements of this list,\nyielding them to the given closure.\n\nReturns a new list that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::List::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nMutates the collection in place replacing the elements with the ones\nreturned by the given closure.", false, false, true, false, value.ToSymbol("map_mut"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::List::Val", env), NormalParameterKind, false)}, NameToType("Std::List::Val", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
			...
			}
			{
				...
				namespace.DefineMethod("Iterates over the key value pairs of this map,\nyielding them to the given closure.\n\nReturns a new map that consists of the key value pairs returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_pairs"), []*TypeParameter{NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Map::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Map::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Map", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the values of this map,\nyielding them to the given closure.\n\nMutates the map in place replacing the values with the ones\nreturned by the given closure.", false, false, true, false, value.ToSymbol("map_values_mut"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Map::Value", env), NormalParameterKind, false)}, NameToType("Std::Map::Value", env), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, Self{}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
			...
			}
			{
				...
				mixin = NewMixin("", false, "", env)
				{
					...
					// Define methods
					namespace.DefineMethod("Returns the iterator for this range.\nOnly ranges of incrementable values can be iterated over.", false, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::OpenRange::Iterator", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::OpenRange::Val", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				}
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::OpenRange::Val", env), NameToType("Std::OpenRange::Val", env), NameToType("Std::OpenRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::OpenRange::Val", env), NameToType("Std::OpenRange::Val", env), NameToType("Std::OpenRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::OpenRange::Val", env), Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::OpenRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::OpenRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Returns an iterator for this structure.", true, false, true, false, value.ToSymbol("iter"), nil, nil, NewGeneric(NameToType("Std::Iterator", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NameToType("Std::PrimitiveIterable::Val", env), COVARIANT), value.ToSymbol("Err"): NewTypeArgument(NameToType("Std::PrimitiveIterable::Err", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Val"), value.ToSymbol("Err")})), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this record.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new list that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new record that consists of the key value pairs returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_pairs"), []*TypeParameter{NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("pair"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Record", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NewTypeParameter(value.ToSymbol("K"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Iterates over the values of this record,\nyielding them to the given closure.\n\nReturns a new record that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map_values"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Record::Value", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Record", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::RightOpenRange::Val", env), NameToType("Std::RightOpenRange::Val", env), NameToType("Std::RightOpenRange::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::RightOpenRange::Val", env), NameToType("Std::RightOpenRange::Val", env), NameToType("Std::RightOpenRange::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Returns the upper bound of the range.", false, false, true, false, value.ToSymbol("end"), nil, nil, NameToType("Std::RightOpenRange::Val", env), Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("Returns the lower bound of the range.", false, false, true, false, value.ToSymbol("start"), nil, nil, NameToType("Std::RightOpenRange::Val", env), Never{})
...

				{
					...
					namespace.DefineMethod("Get the next element of the list.\nThrows `:stop_iteration` when there are no more elements.", false, false, true, false, value.ToSymbol("next"), nil, nil, NameToType("Std::RightOpenRange::Iterator::Val", env), NewSymbolLiteral("stop_iteration"))
					namespace.DefineMethod("Resets the state of the iterator.", false, false, true, false, value.ToSymbol("reset"), nil, nil, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Return the intersection of both sets.\n\nCreate a new set containing only the elements\npresent both in `self` and `other`.", false, false, true, false, value.ToSymbol("&"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Set", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(Never{}, INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", false, false, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Set", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::Set::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
				namespace.DefineMethod("Adds the given value to the set.\n\nDoes nothing if the value is already present in the set.", false, false, true, false, value.ToSymbol("<<"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Set::Val", env), NormalParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Adds the given values to the set.\n\nSkips a value if it is already present in the set.", false, false, true, false, value.ToSymbol("append"), nil, []*Parameter{NewParameter(value.ToSymbol("values"), NameToType("Std::Set::Val", env), PositionalRestParameterKind, false)}, Self{}, Never{})
				namespace.DefineMethod("Check whether the given `value` is present in this set.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Set::Val", env), NameToType("Std::Set::Val", env), NameToType("Std::Set::Val", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("V"), nil, NameToType("Std::Set::Val", env), NameToType("Std::Set::Val", env), NameToType("Std::Set::Val", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Iterates over the elements of this set,\nyielding them to the given closure.\n\nReturns a new Set that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Set::Val", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Set", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
				namespace.DefineMethod("Adds the given value to the set.\n\nReturns `false` if the value is already present in the set.\nOtherwise returns `true`.", true, false, true, false, value.ToSymbol("push"), nil, []*Parameter{NewParameter(value.ToSymbol("value"), NameToType("Std::Set::Val", env), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Return the union of both sets.\n\nCreate a new set containing all the elements\npresent in `self` and `other`.", false, false, true, false, value.ToSymbol("|"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::ImmutableSet", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Set", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Val"): NewTypeArgument(NewUnion(NameToType("Std::Set::Val", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), INVARIANT)}, []value.Symbol{value.ToSymbol("Val")})), Never{})
			...
			}
			{
...

				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("#init"), nil, []*Parameter{NewParameter(value.ToSymbol("string"), NameToType("Std::String", env), NormalParameterKind, false)}, Void{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Create a new `Tuple` containing the elements of `self`\nand another given `Tuple`.", false, true, true, false, value.ToSymbol("+"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("other"), NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewUnion(NameToType("Std::Tuple::Element", env), NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT)), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this tuple,\nyielding them to the given closure.\n\nReturns a new tuple that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Tuple::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT)), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Tuple", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("V"), nil, Never{}, Any{}, nil, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, nil, INVARIANT))
