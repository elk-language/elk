...

	{
...

		{
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::BeginlessClosedRange::Element", env), NameToType("Std::BeginlessClosedRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::BeginlessClosedRange::Element", env), NameToType("Std::BeginlessClosedRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::BeginlessOpenRange::Element", env), NameToType("Std::BeginlessOpenRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::BeginlessOpenRange::Element", env), NameToType("Std::BeginlessOpenRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nReturns a new collection that consists of the elements returned\nby the given closure.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Collection::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
...

				{
					...
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Collection::Base::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Collection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this container.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Container::Element", env), NameToType("Std::Container::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Container::Element", env), NameToType("Std::Container::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::EndlessClosedRange::Element", env), NameToType("Std::EndlessClosedRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::EndlessClosedRange::Element", env), NameToType("Std::EndlessClosedRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, True{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::EndlessOpenRange::Element", env), NameToType("Std::EndlessOpenRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::EndlessOpenRange::Element", env), NameToType("Std::EndlessOpenRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_left_closed"), nil, nil, False{}, Never{})
				namespace.DefineMethod("", false, false, true, false, value.ToSymbol("is_right_closed"), nil, nil, False{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this map.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashMap::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashMap::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this record.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new ArrayList that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::HashRecord::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::HashRecord::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ArrayList", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `value` is present in this set.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::HashSet::Element", env), NameToType("Std::HashSet::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::HashSet::Element", env), NameToType("Std::HashSet::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Returns the number of elements present in the collection.", true, false, true, false, value.ToSymbol("length"), nil, nil, NameToType("Std::Int", env), Never{})
				namespace.DefineMethod("Iterates over the elements of this collection,\nyielding them to the given closure.\n\nReturns a new collection that consists of the elements returned\nby the given closure.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ImmutableCollection::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
...

				{
					...
					// Define methods
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::ImmutableCollection::Base::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::ImmutableCollection", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `value` is present in this iterable.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Iterable::Element", env), NameToType("Std::Iterable::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Iterable::Element", env), NameToType("Std::Iterable::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the elements of this iterable,\nyielding them to the given closure.\n\nReturns a new iterable that consists of the elements returned\nby the given closure.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Iterable", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
				namespace.DefineMethod("Reduces the elements of this iterable to a single value by\niteratively combining them using the provided function.\n\nNever returns if the iterable is infinite.", true, false, true, false, value.ToSymbol("reduce"), []*TypeParameter{NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), Never{})
				...
				}
				{
					...
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Iterable::FiniteBase::Element", env), NameToType("Std::Iterable::FiniteBase::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Iterable::FiniteBase::Element", env), NameToType("Std::Iterable::FiniteBase::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
					...
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Iterable", env).(*Interface), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), COVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
					namespace.DefineMethod("", false, false, true, false, value.ToSymbol("reduce"), []*TypeParameter{NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("accum"), NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), NormalParameterKind, false), NewParameter(value.ToSymbol("element"), NameToType("Std::Iterable::FiniteBase::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("A"), nil, Never{}, Any{}, INVARIANT), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::LeftOpenRange::Element", env), NameToType("Std::LeftOpenRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::LeftOpenRange::Element", env), NameToType("Std::LeftOpenRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Iterates over the elements of this list,\nyielding them to the given closure.\n\nReturns a new list that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::List::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				// Define methods
				namespace.DefineMethod("Check whether the given `value` is present in this range.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::OpenRange::Element", env), NameToType("Std::OpenRange::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::OpenRange::Element", env), NameToType("Std::OpenRange::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `pair` is present in this record.", false, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				...
				namespace.DefineMethod("Iterates over the key value pairs of this record,\nyielding them to the given closure.\n\nReturns a new list that consists of the values returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NewGeneric(NameToType("Std::Pair", env).(*Class), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Key"): NewTypeArgument(NameToType("Std::Record::Key", env), INVARIANT), value.ToSymbol("Value"): NewTypeArgument(NameToType("Std::Record::Value", env), INVARIANT)}, []value.Symbol{value.ToSymbol("Key"), value.ToSymbol("Value")})), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::List", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
			...
			}
			{
				...
				namespace.DefineMethod("Check whether the given `value` is present in this set.", true, false, true, false, value.ToSymbol("contains"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Set::Element", env), NameToType("Std::Set::Element", env), INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("value"), NewTypeParameter(value.ToSymbol("E"), nil, NameToType("Std::Set::Element", env), NameToType("Std::Set::Element", env), INVARIANT), NormalParameterKind, false)}, Bool{}, Never{})
				namespace.DefineMethod("Iterates over the elements of this set,\nyielding them to the given closure.\n\nReturns a new Set that consists of the elements returned\nby the given closure.", false, false, true, false, value.ToSymbol("map"), []*TypeParameter{NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT)}, []*Parameter{NewParameter(value.ToSymbol("fn"), NewClosureWithMethod("", false, false, true, false, value.ToSymbol("call"), nil, []*Parameter{NewParameter(value.ToSymbol("element"), NameToType("Std::Set::Element", env), NormalParameterKind, false)}, NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), Never{}), NormalParameterKind, false)}, NewGeneric(NameToType("Std::Set", env).(*Mixin), NewTypeArguments(TypeArgumentMap{value.ToSymbol("Element"): NewTypeArgument(NewTypeParameter(value.ToSymbol("E"), nil, Never{}, Any{}, INVARIANT), INVARIANT)}, []value.Symbol{value.ToSymbol("Element")})), Never{})
