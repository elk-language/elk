...
func TestBytecodeFunction_Disassemble(t *testing.T) {
	tests := map[string]struct {
		in   *vm.BytecodeFunction
		want string
		err  string
	}{
...
`,
		...
		"correctly format catch entries": {
			in: vm.NewBytecodeFunctionWithCatchEntries(
				mainSymbol,
...
`,
		...
		"correctly format the INIT_NAMESPACE opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.INIT_NAMESPACE)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
...
0000  1       52 01 00          INSTANTIATE16     256             
`,
		},
...
`,
		...
		"correctly format the AS opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.AS)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
...
`,
		...
		"correctly format the JUMP_TO_FINALLY opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.JUMP_TO_FINALLY)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
...
0000  1       8B 00             CALL8             0 (CallSiteInfo{name: :foo, argument_count: 0})
`,
		},
		"correctly format the CALL16 opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.CALL16), 0x01, 0x00},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				[]value.Value{0x1_00: value.NewCallSiteInfo(value.ToSymbol("foo"), 0)},
...
0000  1       8C 01 00          CALL16            256 (CallSiteInfo{name: :foo, argument_count: 0})
`,
		},
		"correctly format the CALL32 opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.CALL32), 0x01, 0x00, 0x00, 0x00},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				[]value.Value{0x1_00_00_00: value.NewCallSiteInfo(value.ToSymbol("foo"), 0)},
...
`,
		...
		"correctly format the DEF_METHOD_ALIAS opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.DEF_METHOD_ALIAS)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
...
0000  1       95                DEF_METHOD_ALIAS
`,
		},
		"correctly format the GET_CONST8 opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.GET_CONST8), 0},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
...
0000  1       96 00             GET_CONST8        0 (:"Foo::Bar")
`,
		},
		"correctly format the GET_CONST16 opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.GET_CONST16), 0x01, 0x00},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
...
0000  1       97 01 00          GET_CONST16       256 (:"Foo::Bar")
`,
		},
		"correctly format the GET_CONST32 opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.GET_CONST32), 0x01, 0x00, 0x00, 0x00},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
...
0000  1       98 01 00 00 00    GET_CONST32       16777216 (:"Foo::Bar")
`,
		},
		"correctly format the DEF_CONST opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.DEF_CONST)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
...
`,
		...
		"correctly format the EXEC opcode": {
			in: vm.NewBytecodeFunction(
				mainSymbol,
				[]byte{byte(bytecode.EXEC)},
				L(P(12, 2, 3), P(18, 2, 9)),
				bytecode.LineInfoList{bytecode.NewLineInfo(1, 1)},
				0, 0,
				nil,
