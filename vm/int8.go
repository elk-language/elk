...
func initInt8() {
	...
	Def(
		...
		func(_ *VM, args []value.Value) (value.Value, value.Value) {
			self := args[0].AsInt8()
			return value.ToValueErr(value.StrictIntLogicalLeftBitshift(self, args[1], value.LogicalRightShift8))
		},
		DefWithParameters(1),
	)
	Def(
	...
	Def(
		...
		func(_ *VM, args []value.Value) (value.Value, value.Value) {
			self := args[0].AsInt8()
			return value.ToValueErr(value.StrictIntLogicalRightBitshift(self, args[1], value.LogicalRightShift8))
		},
		DefWithParameters(1),
	)
	Def(
