		...
		"compile runtime value": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("Foo").ToValue(),
					value.Ref(vm.NewCallSiteInfo(symbol.OpGreaterThan, 1)),
				},
			),
		},
	}
		...
		"compile runtime value": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("Foo").ToValue(),
					value.Ref(vm.NewCallSiteInfo(symbol.OpGreaterThanEqual, 1)),
				},
			),
		},
	}
		...
		"compile runtime value": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("Foo").ToValue(),
					value.Ref(vm.NewCallSiteInfo(symbol.OpLessThan, 1)),
				},
			),
		},
	}
		...
		"compile runtime value": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("Foo").ToValue(),
					value.Ref(vm.NewCallSiteInfo(symbol.OpLessThanEqual, 1)),
				},
			),
		},
	}
