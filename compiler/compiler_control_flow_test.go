		...
		"with a pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 0x46,
					byte(bytecode.DUP),
		...
		"with break": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 41,
					byte(bytecode.SET_LOCAL8), 2,
					byte(bytecode.POP),
					byte(bytecode.GET_CONST8), 2,
					byte(bytecode.UNDEFINED),
		...
		"with break with value": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 42,
					byte(bytecode.SET_LOCAL8), 2,
					byte(bytecode.POP),
					byte(bytecode.GET_CONST8), 2,
					byte(bytecode.UNDEFINED),
		...
		"nested with break": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 69,
					byte(bytecode.SET_LOCAL8), 2,
					byte(bytecode.POP),
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.COPY),
		...
		"nested with continue": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 68,
					byte(bytecode.SET_LOCAL8), 2,
					byte(bytecode.POP),
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.COPY),
		...
		"with a pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.POP),
					byte(bytecode.GET_LOCAL8), 1,
					byte(bytecode.FOR_IN_BUILTIN), 0, 70,
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 36,
		...
		"finally": {
			...
			want: vm.NewBytecodeFunctionWithCatchEntries(
				...
				[]byte{
					...
					byte(bytecode.SWAP),
					byte(bytecode.JUMP_UNLESS_UNP), 0, 3,
					byte(bytecode.POP_2),
