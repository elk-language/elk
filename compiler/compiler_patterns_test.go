		...
		"list pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 154,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 3,
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 144,
					byte(bytecode.POP),
					...
					byte(bytecode.JUMP_UNLESS), 0, 130,
					byte(bytecode.POP),
					...
					byte(bytecode.FALSE),
					byte(bytecode.POP_SKIP_ONE),
					byte(bytecode.JUMP_UNLESS), 0, 99,
					byte(bytecode.POP),
					...
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 81,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 12,
					byte(bytecode.LOAD_VALUE8), 10,
					byte(bytecode.EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 71,
					byte(bytecode.POP),
					...
					byte(bytecode.TRUE),
					byte(bytecode.POP_SKIP_ONE),
					byte(bytecode.JUMP_UNLESS), 0, 59,
					byte(bytecode.POP),
					...
					byte(bytecode.JUMP_UNLESS), 0, 6,
					byte(bytecode.POP),
					byte(bytecode.CALL_METHOD8), 13,
					byte(bytecode.JUMP), 0, 4,
					byte(bytecode.POP),
					byte(bytecode.POP_N), 2,
					byte(bytecode.FALSE),
					byte(bytecode.JUMP_UNLESS), 0, 23,
					byte(bytecode.POP),
					byte(bytecode.DUP),
		...
		"list pattern with rest elements": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 162,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 3,
					...
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 150,
					byte(bytecode.POP),
					...
					byte(bytecode.LOAD_VALUE8), 6,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 78,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 7,
					...
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 66,
					byte(bytecode.POP),
		...
		"list pattern with unnamed rest elements": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 94,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 3,
					byte(bytecode.SET_LOCAL8), 4,
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 82,
					byte(bytecode.POP),
					...
					byte(bytecode.LOAD_VALUE8), 5,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 50,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					...
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 38,
					byte(bytecode.POP),
		...
		"map pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 5,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 155,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 6,
					byte(bytecode.SUBSCRIPT),
