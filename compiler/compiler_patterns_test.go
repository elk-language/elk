		...
		"list pattern with rest elements": {
			...
			want: vm.NewBytecodeMethodNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 145,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 3,
					...
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 133,
					byte(bytecode.POP),
					...
					byte(bytecode.LOAD_VALUE8), 6,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 61,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 7,
					...
					byte(bytecode.LOAD_VALUE8), 4,
					byte(bytecode.GREATER_EQUAL),
					byte(bytecode.JUMP_UNLESS), 0, 49,
					byte(bytecode.POP),
		...
		"list pattern with unnamed rest elements": {
			...
			want: vm.NewBytecodeMethodNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 5,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 33,
					byte(bytecode.POP),
					byte(bytecode.DUP),
		...
		"tuple pattern": {
			...
			want: vm.NewBytecodeMethodNoParams(
				...
				[]byte{
					...
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 5,
					byte(bytecode.CALL_PATTERN8), 12,
					byte(bytecode.JUMP_UNLESS), 0, 6,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 13,
					byte(bytecode.CALL_PATTERN8), 14,
					byte(bytecode.POP_SKIP_ONE),
					byte(bytecode.JUMP_UNLESS), 0, 2,
					byte(bytecode.POP),
					byte(bytecode.TRUE),
		...
		"map pattern": {
			...
			want: vm.NewBytecodeMethodNoParams(
				...
				[]byte{
					...
					byte(bytecode.LOAD_VALUE8), 5,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 104,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 6,
					byte(bytecode.SUBSCRIPT),
					...
					byte(bytecode.CALL_PATTERN8), 8,
					byte(bytecode.POP_SKIP_ONE),
					byte(bytecode.JUMP_UNLESS), 0, 90,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 9,
					byte(bytecode.SUBSCRIPT),
					...
					byte(bytecode.DUP),
					byte(bytecode.LOAD_VALUE8), 16,
					byte(bytecode.CALL_PATTERN8), 17,
					byte(bytecode.POP_SKIP_ONE),
					byte(bytecode.JUMP_UNLESS), 0, 2,
					byte(bytecode.POP),
					byte(bytecode.TRUE),
		...
		"object pattern": {
			...
			want: vm.NewBytecodeMethodNoParams(
				...
				[]byte{
					...
					byte(bytecode.GET_MOD_CONST8), 2,
					byte(bytecode.IS_A),
					byte(bytecode.JUMP_UNLESS), 0, 32,
					byte(bytecode.POP),
					byte(bytecode.DUP),
					byte(bytecode.CALL_METHOD8), 3,
					byte(bytecode.SET_LOCAL8), 4,
