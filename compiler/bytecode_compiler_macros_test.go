		...
		"unquote expression": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.IntLiteralNodeClass, "to_ast_node"), 0)),
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.KernelModule.SingletonClass(), "#splice"), 2)),
				},
			),
		},
		...
		"unquote identifier": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.IdentifierNodeMixin, "to_ast_ident_node"), 0)),
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.KernelModule.SingletonClass(), "#splice"), 2)),
				},
			),
		},
		...
		"unquote constant": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.ConstantNodeMixin, "to_ast_const_node"), 0)),
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.KernelModule.SingletonClass(), "#splice"), 2)),
				},
			),
		},
		...
		"unquote_ivar": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("foo").ToValue(),
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.InstanceVariableNodeMixin, "to_ast_ivar_node"), 0)),
					value.Ref(vm.NewNativeCallSiteInfo(nativeMethodStr(value.KernelModule.SingletonClass(), "#splice"), 2)),
				},
			),
		},
