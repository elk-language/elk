		...
		"without unquote": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
		...
		"unquote expression": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo((value.IntLiteralNodeClass).LookupMethod(value.ToSymbol("to_ast_node")).(*vm.NativeMethod), 0)),
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
		...
		"unquote identifier": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo((value.IdentifierNodeMixin).LookupMethod(value.ToSymbol("to_ast_ident_node")).(*vm.NativeMethod), 0)),
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
		...
		"unquote pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo((value.PatternNodeMixin).LookupMethod(value.ToSymbol("to_ast_pattern_node")).(*vm.NativeMethod), 0)),
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
		...
		"unquote constant": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewNativeCallSiteInfo((value.ConstantNodeMixin).LookupMethod(value.ToSymbol("to_ast_const_node")).(*vm.NativeMethod), 0)),
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
		...
		"unquote_ivar": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("foo").ToValue(),
					value.Ref(vm.NewNativeCallSiteInfo((value.InstanceVariableNodeMixin).LookupMethod(value.ToSymbol("to_ast_ivar_node")).(*vm.NativeMethod), 0)),
					value.Ref(vm.NewNativeCallSiteInfo((value.KernelModule.SingletonClass()).LookupMethod(value.ToSymbol("#splice")).(*vm.NativeMethod), 2)),
				},
			),
		},
			...
			wantFn: func(btc bytecodeTestCase) *vm.BytecodeFunction {
				...
				return vm.NewBytecodeFunctionNoParams(
					...
					[]value.Value{
						...
						value.Ref(vm.NewBytecodeCallSiteInfo(bar, 0, false)),
					},
				)
			},
		},
