		...
		"without unquote": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote expression": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_expr_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote identifier": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_ident_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote pattern expression": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_pattern_expr_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote pattern": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_pattern_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote constant": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_const_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
		...
		"unquote_ivar": {
			...
			want: vm.NewBytecodeFunctionNoParams(
				...
				[]value.Value{
					...
					value.ToSymbol("foo").ToValue(),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("to_ast_ivar_node"), 0)),
					value.Ref(vm.NewCallSiteInfo(value.ToSymbol("#splice"), 2)),
				},
			),
		},
