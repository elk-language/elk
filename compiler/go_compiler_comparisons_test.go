...
`,
		...
		"equal smallint builtin": {
			input: `
					...
					`,
			err: diagnostic.DiagnosticList{
				diagnostic.NewWarning(L(P(29, 3, 12), P(29, 3, 12)), "this equality check is impossible, `23` cannot ever be equal to `2.5`"),
			},
			want: `package main
...
func main() { // loc: <main>
	...
	defer thread.PopNativeCallFrame()
	l0 = value.SmallInt(23)
	l1 = value.Bool(value.Equal((l0).ToValue(), (value.Float(2.5)).ToValue()))
}
`,
		},
		"equal smallint int": {
...
func main() { // loc: <main>
	...
	l0 = value.SmallInt(23)
	l1 = (value.SmallInt(5)).ToValue()
	l2 = value.Bool(value.Equal((l0).ToValue(), l1))
}
`,
		},
...
func main() { // loc: <main>
	...
	l0 = bi0
	l1 = value.Float(5.5)
	l2 = value.Bool(value.Equal((l0).ToValue(), (l1).ToValue()))
}
`,
		},
		"equal bigint bigint": {
